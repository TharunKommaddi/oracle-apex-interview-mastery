...
(function() {
    ...
    const Auth = {
        ...
        admin: {
            ...
            approveUser: function(email, fullName, accessType, password) {
                ...
                console.log('📧 Send them their credentials:');
            ...
            rejectUser: function(email, reason = '') {
                ...
                if (requestIndex !== -1) {
                    ...
                    console.log('❌ User request rejected:', email);
                    return true;
                }
    ...
    console.log('🚀 APEX Interview Mastery Authentication System loaded!');
    console.log('📧 Admin Email:', 'tharunkommaddi@gmail.com');
    console.log('🔧 Admin functions available via: AuthAdmin');
    console.log('📝 Example: AuthAdmin.approveUser("user@example.com", "John Doe", "student", "password123")');
